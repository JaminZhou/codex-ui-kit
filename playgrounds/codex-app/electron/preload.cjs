...
contextBridge.exposeInMainWorld("codexDemo", {
  ...
  listEnvironments: (input) => ipcRenderer.invoke("demo:environment:list", input),
  ...
  previewPush: (input) => ipcRenderer.invoke("demo:git:push-preview", input),
  ...
  listPullRequestHistory: (input) => ipcRenderer.invoke("demo:git:pr-history", input),
  ...
  readPullRequestConversation: (input) => ipcRenderer.invoke("demo:git:pr-conversation", input),
  readPullRequestReviewThreadReplies: (input) => ipcRenderer.invoke("demo:git:pr-thread-replies", input),
  readPullRequestDiff: (input) => ipcRenderer.invoke("demo:git:pr-diff", input),
