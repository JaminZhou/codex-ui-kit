...
function initialComposerOverlay(frame: string | null): ComposerOverlay {
  ...
  if (
    ...
    frame === "workspace-composer-current-26-917-71314-resources"
  ) {
    return "resources";
  }
  return null;
...
// 26.911 keeps the public resource vocabulary and row descriptions observed
// by the installed CDP capture. Keep this as a named current-build variant so
...
function McpResponseActions({
  ...
  return (
    ...
    >
      ...
      {rateResponse ? (
        <button aria-label="Rate response" type="button">
...
export function App() {
  ...
  const currentComposerControls2691762051Replay =
    ...
    !initialSelection.frame?.startsWith(
      "workspace-composer-current-26-917-71314-",
    );
  const currentComposerControls2691771314Replay =
    initialSelection.view === "workspace" &&
    initialSelection.frame?.startsWith(
      "workspace-composer-current-26-917-71314-",
    );
      ...
      : currentComposerControlsCurrentCatalogReplay
        ? currentComposerResourceMentionReplay
          ...
          : composerOverlay === "resources"
            ...
            : currentComposerControls2691771314Replay
              ? "workspace-composer-current-26-917-71314-ready"
              : currentComposerControls2691762051Replay
          ...
          <ComposerResourcePicker
            ...
            groups={
              currentComposerControlsCurrentCatalogReplay
                ? currentComposerControls2690870816Replay
                  ? currentComposerControls2691771314Replay
                    ? currentComposerResourceGroups2691771314
                    : currentComposerControls2691762051Replay
                    ? currentComposerResourceGroups2691762051
                    : currentComposerControls2691531945Replay
                    ? currentComposerResourceGroups2691531945
      ...
      const currentMcpCaptureOpen =
        (isCurrentMcpSuccessReplay &&
          (activeFrame === "mcp-current-running" ||
            ...
            activeFrame === "mcp-current-26-903-success" ||
  ...
  return (
    <div
      ...
      data-current-context-26-825={
        currentContext26825Replay && !currentComposerControlsCurrentCatalogReplay
          ? true
          : undefined
      }
      ...
      data-current-composer-controls-26-917-71314={
        currentComposerControls2691771314Replay || undefined
      }
                    ...
                    <>
                      ...
                      >
                        <ThreadSummaryItem
                          label="Changes"
                          leading={<SummaryGlyph name="changes" />}
                          meta={<ThreadSummaryDelta added={511} removed={146} />}
                        />
                        <ThreadSummaryItem
                          label="Local"
                          leading={<SummaryGlyph name="computer" />}
                        ...
                        />
                        <ThreadSummaryItem
                          label="fix/library-loading-and-scale"
                          leading={<SummaryGlyph name="branch" />}
                          title="Switch branch"
                          trailing="⌄"
                        />
