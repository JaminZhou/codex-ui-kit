...
const artifactDirectory = await mkdtemp(
  join(tmpdir(), "ui-kit-current-document-media-26-911-"),
);

const scenes = [
  {
    expectedKind: "document",
    frame: "workspace-current-26-911-doc-preview-ready",
    id: "workspace-current-26-911-doc-preview-ready",
  ...
  },
  {
    expectedKind: "document",
    frame: "workspace-current-26-911-doc-preview-ready",
    id: "workspace-current-26-911-doc-preview-ready-compact",
    scenario: "workspace-workflow",
    sidebarState: "hidden",
    theme: "dark",
    view: "workspace",
  ...
  {
    expectedKind: "image",
    frame: "workspace-current-26-911-image-preview-ready",
    id: "workspace-current-26-911-image-preview-ready",
    scenario: "workspace-workflow",
    theme: "dark",
    view: "workspace",
    windowSize: { height: 820, width: 1180 },
  },
  {
    expectedKind: "image",
    frame: "workspace-current-26-911-image-preview-ready",
    id: "workspace-current-26-911-image-preview-ready-compact",
    scenario: "workspace-workflow",
    sidebarState: "hidden",
    theme: "dark",
    view: "workspace",
