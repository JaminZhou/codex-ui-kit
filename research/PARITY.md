...
- Three current-build subagent tasks now separate the single-success contract
  ...
  failed-agent transcript access. Browser/CDP covers 131 frames, Electron
...
and viewport preview. Browser/CDP now covers 131 frames; Electron repeats copy,
horizontal wheel, open/close, and focus restoration; two reviewed internal
baselines pass. A local-only 1180×820 reference gates the owned preview and
