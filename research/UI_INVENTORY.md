...
paths, and the failed-agent transcript. Browser/CDP reaches 131 frames;
...
131 frames, Electron repeats raw Markdown/HTML copy, horizontal wheel and
preview interaction, and two reviewed internal baselines pass. A local-only
