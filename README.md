...
| [Tools and approvals](docs/COMPONENTS.md#tools-approvals-and-status) | `BrowserActivity`, `ToolCallCard`, `CommandExecution`, `FileChange`, `FileChangeGroup`, `ApprovalRequest` |
