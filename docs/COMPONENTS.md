...
- `Dialog` and `DialogChoice`: controlled modal presentation with compact, standard, and wide sizes; focus trapping/restoration; scroll locking; Escape/backdrop dismissal; and descriptive choice rows.
